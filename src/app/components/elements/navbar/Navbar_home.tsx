...
const Navbar_home = () => {
  return (
<div className="fixed left-0 top-0 h-screen px-4 py-8 border-r-4 border-[var(--color-v-1)]">
  <nav className="flex flex-col justify-between h-full items-center">
    {['Inicio', '¿Qué hace?', 'Utilidades', 'Comprar'].map((item, index) => (
      <div key={item} className="flex flex-col items-center h-32 justify-center relative w-full group">
        {/* Contenedor de texto */}

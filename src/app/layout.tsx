...
import { K2D, Urbanist, Anonymous_Pro } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html lang="es" className={`${k2d.variable} ${urbanist.variable} ${anonymousPro.variable}`} suppressHydrationWarning>
      <head>
